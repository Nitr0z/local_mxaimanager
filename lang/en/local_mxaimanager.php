...
$string['openai_vision_model'] = 'OpenAI Vision Model';
$string['openai_vision_model_help'] = 'Vision-capable chat model used to read images. For example: <strong>gpt-4o</strong>, <strong>gpt-4.1</strong>. Do not use a text-only model.';
$string['mistral_vision_model'] = 'Mistral Vision Model';
$string['mistral_vision_model_help'] = 'Vision-capable chat model used to read images. For example: <strong>pixtral-large-latest</strong>.';
$string['ollama_vision_model'] = 'Ollama Vision Model';
$string['ollama_vision_model_help'] = 'Vision-capable Ollama model used to read images. For example: <strong>llava</strong>, <strong>llama3.2-vision</strong>.';
$string['nebius_vision_model'] = 'Nebius Vision Model';
$string['nebius_vision_model_help'] = 'Vision-capable chat model used to read images. Refer to Nebius documentation.';
$string['scaleway_chat_model'] = 'Scaleway Chat Model';
$string['scaleway_chat_model_help'] = 'Specify the chat model to use. For example: <strong>llama-3.3-70b-instruct</strong>, <strong>qwen2.5-72b-instruct</strong>. Refer to Scaleway documentation.';
$string['scaleway_embedding_model'] = 'Scaleway Embedding Model';
$string['scaleway_embedding_model_help'] = 'Specify the embedding model to use. For example: <strong>baai/bge-multilingual-gemma2</strong>. Refer to Scaleway documentation.';
$string['scaleway_image_model'] = 'Scaleway Image Model';
$string['scaleway_image_model_help'] = 'Specify the image generation model to use. For example: <strong>black-forest-labs/flux-schnell</strong>.';
$string['scaleway_vision_model'] = 'Scaleway Vision Model';
$string['scaleway_vision_model_help'] = 'Vision-capable model used to read images. Must accept OpenAI-style image_url chat content.';
...
$string['default_vision_model'] = 'Default Vision Model';
...
$string['supports_vision'] = 'Supports Vision';
