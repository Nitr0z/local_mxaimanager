...
class behat_local_mxaimanager extends behat_base
{
     ...
     *
     * @Given /^I check that mxaimanager "(?P<has_or_has_not>has|has not)" an AI provider instance configured$/
     */
    public function i_check_that_mxaimanager_has_or_has_not_an_AI_provider_instance_configured(string $has_or_has_not): void
    {
