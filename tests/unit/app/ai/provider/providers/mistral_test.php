...
class mistral_test extends \base_testcase
{
    ...
    public function test_constructor_with_valid_config(): void
    {
        ...
        $this->assertInstanceOf(\local_mxaimanager\app\ai\provider\providers\mistral::class, $provider);
    }
    ...
    public function test_constructor_missing_base_url(): void
    {
        ...
        $this->expectExceptionMessage('Mistral is missing base url and/or api key');

        new \local_mxaimanager\app\ai\provider\providers\mistral(
            $this->mock_base_factory,
            $json_config
        );
    }
        ...
        $this->mock_curl->expects($this->once())
            ...
            ->with(
                ...
                $this->callback(function ($data) {
                    ...
                    return isset($decoded['model'], $decoded['messages']) && $decoded['model'] === 'mistral-tiny';
                })
            )
            ...
            ->with(
                ...
                $this->callback(function ($data) {
                    ...
                    return isset($decoded['model']) &&
                        $decoded['model'] === 'mistral-embed' &&
                        isset($decoded['input']) &&
                        isset($decoded['output_dimension']) &&
                        $decoded['output_dimension'] === 512;
                })
            )
            ->willReturn($expected_response);
    ...
    public function test_moodleform_definition(): void
    {
        ...
        \local_mxaimanager\app\ai\provider\providers\mistral::moodleform_definition(
            $mform,
            $element_name_prefix
        );
